    ...
    <div class="container">
      <div class="card-container card-container-timeline">
        <article class="card flex-column bg-gray-700 gray-300">
          <div>
            <img class="image" src="assets/images/angriffderclonkrieger.jpg" alt="angriff der klonkrieger">
          </div>
          <span>
        ...
        <article class="card flex-column bg-gray-700 gray-300">
          <div>
            <img class="image" src="assets/images/klonkriege.jpg" alt="angriff der klonkrieger">
          </div>
          <span>
            Die erste animierte Serie im Star Wars Universium erklärt politische Zusammenhänge bezüglich Mandalore und die kriegerische Vergangenheit sowie die terroristischen mandalorianischen Organisationen und der Machthunger der Mandalorianer. Sie thematisiert das Dilemma der Seperatisten und die Machtstrukturen der Mandalorianer sowie deren Verbissenheit.
          </span>
        </article>
        <article class="card flex-column bg-gray-700 gray-300">
          <div>
            <img class="image" src="assets/images/rebels.jpg" alt="rebels">
          </div>
          <span>
        ...
        <article class="card flex-column bg-gray-700 gray-300">
          ...
          </span class="image" src="assets/images/mando.jpg" alt="mandalorian">
          <img class="image" src="assets/images/blacksmith.jpg" alt="mandalorian-blacksmith">
        </article>
        <article class="card bg-gray-700 gray-300">
          <img class="image" src="assets/images/bobafett.jpg" alt="boba fett">
          <span>
            ...
            Wirklich relevant für die Mandalorianische Geschichte sind hier nur Ausschnitte, wie Bobas Rüstung, das für Mandalorianer typische Jagen und Zähmen von wilden Tieren und Kampfszenen die bestimmte Gadgets darstellen.
          </span>
        </article>
      </div>
    </div>
