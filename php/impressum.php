...
<head>
  ...
  echo generate_og_tags($title, "Impressum");
  ?>
</head>
...
<body>
  <main class="container">
    ...
    <ul>
      <li>Telefon: 1234 1234 1234</li>
      <li>E-Mail: max.mustermann@mustermail.de</li>
    </ul>
    <h2>Umsatzsteuer-ID</h2>
    <pre>Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:</pre>
    DE 123 456 789
